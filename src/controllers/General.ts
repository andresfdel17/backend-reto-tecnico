...
import { IRouteWithVehicle, IDriver } from '@types';
...
General.get('/drivers', [getUserData, modifyDataRateLimit], async (_req: Request, res: Response) => {
    // Query para obtener todos los conductores disponibles
    const driversQuery = `
        SELECT 
            id,
            cifnif,
